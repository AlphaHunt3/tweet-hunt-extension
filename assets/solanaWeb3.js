  ...
  window.solanaWeb3 = (function (exports) {
    ...
    const crypto$1 =
      typeof globalThis === 'object' && 'crypto' in globalThis
        ? globalThis.crypto
        : undefined;
    /*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const createView$1 =
      (arr) => new DataView(arr.buffer, arr.byteOffset, arr.byteLength);
    ...
    function split$1(lst, le = false) {
      ...
      for (let i = 0; i < lst.length; i++) {
        const { h: h, l: l } = fromBig$1(lst[i], le);
        [Ah[i], Al[i]] = [h, l];
      }
      return [Ah, Al];
    }
    ...
    function wNAF(c, bits) {
      return {
        ...
        precomputeWindow(elm, W) {
          const { windows: windows, windowSize: windowSize } = calcWOpts(
            W,
            bits
          );
          const points = [];
        ...
        wNAFCachedUnsafe(P, n, transform, prev) {
          ...
          return this.wNAFUnsafe(
            W,
            this.getPrecomputes(W, P, transform),
            n,
            prev
          );
        },
    ...
    /*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const ED25519_P =
      BigInt(
    ...
    /*! safe-buffer. MIT License. Feross Aboukhadijeh <https://feross.org/opensource> */ var hasRequiredSafeBuffer;
    ...
    /*! noble-hashes - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const u32 =
      (arr) =>
        new Uint32Array(
          arr.buffer,
          arr.byteOffset,
    ...
    const SHA256_IV$1 = new Uint32Array([
    ...
    let SHA256$1 = class SHA256 extends HashMD {
      ...
      process(view, offset) {
        ...
        for (let i = 16; i < 64; i++) {
          ...
          SHA256_W$1[i] =
            (s1 + SHA256_W$1[i - 7] + s0 + SHA256_W$1[i - 16]) | 0;
        }
        let { A: A, B: B, C: C, D: D, E: E, F: F, G: G, H: H } = this;
        for (let i = 0; i < 64; i++) {
          const sigma1 = rotr(E, 6) ^ rotr(E, 11) ^ rotr(E, 25);
          const T1 =
            (H + sigma1 + Chi(E, F, G) + SHA256_K$1[i] + SHA256_W$1[i]) | 0;
    ...
    let Struct$1 = class Struct {
      ...
      encode() {
        return bufferExports.Buffer.from(
          libExports.serialize(SOLANA_SCHEMA, this)
        );
      }
      static decode(data) {
    ...
    class PublicKey extends Struct$1 {
      ...
      static async createWithSeed(fromPublicKey, seed, programId) {
        const buffer = bufferExports.Buffer.concat([
          fromPublicKey.toBuffer(),
          bufferExports.Buffer.from(seed),
          programId.toBuffer(),
        ]);
      ...
      static createProgramAddressSync(seeds, programId) {
        ...
        buffer = bufferExports.Buffer.concat([
          buffer,
          programId.toBuffer(),
        ...
        while (nonce != 0) {
          try {
            const seedsWithNonce = seeds.concat(
              bufferExports.Buffer.from([nonce])
            );
    ...
    class Account {
      ...
      get secretKey() {
        return bufferExports.Buffer.concat(
          [this._secretKey, this._publicKey],
          64
        );
      }
    }
    ...
    function requireLayout() {
      ...
      Layout.s16 =
        ...
        Layout.Union =
        Layout.UnionLayoutDiscriminator =
        Layout.UnionDiscriminator =
        Layout.Structure =
        Layout.Sequence =
        Layout.DoubleBE =
        Layout.Double =
        ...
        Layout.bindConstructorLayout =
        Layout.nameWithProperty =
        Layout.Layout =
        Layout.uint8ArrayToBuffer =
        Layout.checkUint8Array =
          void 0;
      Layout.constant =
        Layout.utf8 =
        Layout.cstr =
      ...
      class BitField {
        constructor(container, bits, property) {
          ...
          const usedBits = container.fields.reduce(
            (sum, fd) => sum + fd.bits,
            0
          );
      ...
      Layout.greedy = (elementSpan, property) =>
        new GreedyCount(elementSpan, property);
      Layout.offset = (layout, offset, property) =>
      ...
      Layout.struct = (fields, property, decodePrefixes) =>
        new Structure(fields, property, decodePrefixes);
      Layout.bits = (word, msb, property) =>
        new BitStructure(word, msb, property);
      Layout.seq = (elementLayout, count, property) =>
        new Sequence(elementLayout, count, property);
      Layout.union = (discr, defaultLayout, property) =>
        new Union(discr, defaultLayout, property);
      Layout.unionLayoutDiscriminator = (layout, property) =>
    ...
    const publicKey = (property = 'publicKey') =>
      LayoutExports.blob(32, property);
    const signature = (property = 'signature') =>
      LayoutExports.blob(64, property);
    const rustString = (property = 'string') => {
      const rsl = LayoutExports.struct(
        [
          LayoutExports.u32('length'),
          LayoutExports.u32('lengthPadding'),
          LayoutExports.blob(
            LayoutExports.offset(LayoutExports.u32(), -8),
            'chars'
          ),
        ],
        property
      ...
      rslShim.encode = (str, b, offset) => {
        const data = { chars: bufferExports.Buffer.from(str, 'utf8') };
        return _encode(data, b, offset);
      };
      rslShim.alloc = (str) =>
        LayoutExports.u32().span +
        LayoutExports.u32().span +
        bufferExports.Buffer.from(str, 'utf8').length;
      return rslShim;
    };
    ...
    class Message {
      ...
      isAccountWritable(index) {
        ...
        if (index >= this.header.numRequiredSignatures) {
          ...
          const numUnsignedAccounts =
            this.accountKeys.length - numSignedAccounts;
      ...
      serialize() {
        ...
        instructions.forEach((instruction) => {
          const instructionLayout = LayoutExports.struct([
            ...
            LayoutExports.seq(
              LayoutExports.u8('keyIndex'),
              instruction.keyIndices.length,
              'keyIndices'
            ),
            LayoutExports.blob(instruction.dataLength.length, 'dataLength'),
            LayoutExports.seq(
              LayoutExports.u8('userdatum'),
        ...
        const signDataLayout = LayoutExports.struct([
          ...
          LayoutExports.blob(keyCount.length, 'keyCount'),
          LayoutExports.seq(publicKey('key'), numKeys, 'keys'),
      ...
      static from(buffer) {
        ...
        const messageArgs = {
          ...
          recentBlockhash: bs58.encode(
            bufferExports.Buffer.from(recentBlockhash)
          ),
    ...
    class MessageV0 {
      ...
      serialize() {
        ...
        const serializedAddressTableLookups =
        ...
        const messageLayout = LayoutExports.struct([
      ...
      serializeInstructions() {
        ...
        for (const instruction of this.compiledInstructions) {
          ...
          const instructionLayout = LayoutExports.struct([
            ...
            LayoutExports.blob(encodedDataLength.length, 'encodedDataLength'),
            LayoutExports.blob(instruction.data.length, 'data'),
          ]);
      ...
      serializeAddressTableLookups() {
        ...
        for (const lookup of this.addressTableLookups) {
          ...
          const addressTableLookupLayout = LayoutExports.struct([
    ...
    const DEFAULT_SIGNATURE = bufferExports.Buffer.alloc(
    ...
    class Transaction {
      ...
      constructor(opts) {
        ...
        if (Object.prototype.hasOwnProperty.call(opts, 'nonceInfo')) {
          ...
          const { recentBlockhash: recentBlockhash, nonceInfo: nonceInfo } =
            opts;
          if (nonceInfo) {
            this.nonceInfo = nonceInfo;
          }
      ...
      _serialize(signData) {
        ...
        signatures.forEach(({ signature: signature }, index) => {
          if (signature !== null) {
            ...
            bufferExports.Buffer.from(signature).copy(
              wireTransaction,
    ...
    class VersionedTransaction {
      ...
      serialize() {
        ...
        const transactionLayout = LayoutExports.struct([
          LayoutExports.blob(
            encodedSignaturesLength.length,
            'encodedSignaturesLength'
          ),
          LayoutExports.seq(signature(), this.signatures.length, 'signatures'),
          LayoutExports.blob(serializedMessage.length, 'serializedMessage'),
        ]);
    ...
    const NonceAccountLayout = LayoutExports.struct([
      LayoutExports.u32('version'),
      LayoutExports.u32('state'),
      publicKey('authorizedPubkey'),
      publicKey('nonce'),
      LayoutExports.struct([FeeCalculatorLayout], 'feeCalculator'),
    ]);
    ...
    const bigInt = (length) => (property) => {
      ...
      const { encode: encode, decode: decode } = encodeDecode(layout);
    ...
    class SystemInstruction {
      ...
      static decodeTransfer(instruction) {
        this.checkProgramId(instruction.programId);
        this.checkKeyLength(instruction.keys, 2);
        const { lamports: lamports } = decodeData$1(
      ...
      static decodeAllocate(instruction) {
        ...
        const { space: space } = decodeData$1(
      ...
      static decodeAssign(instruction) {
        this.checkProgramId(instruction.programId);
        this.checkKeyLength(instruction.keys, 1);
        const { programId: programId } = decodeData$1(
      ...
      static decodeNonceInitialize(instruction) {
        this.checkProgramId(instruction.programId);
        this.checkKeyLength(instruction.keys, 3);
        const { authorized: authorized } = decodeData$1(
    ...
    class Loader {
      ...
      static async load(connection, payer, program, programId, data) {
        ...
        const dataLayout = LayoutExports.struct([
          LayoutExports.u32('instruction'),
          LayoutExports.u32('offset'),
          LayoutExports.u32('bytesLength'),
          LayoutExports.u32('bytesLengthPadding'),
          LayoutExports.seq(
            LayoutExports.u8('byte'),
            LayoutExports.offset(LayoutExports.u32(), -8),
            'bytes'
          ),
        ]);
        ...
        await Promise.all(transactions);
        {
          ...
          const { context: context, value: value } =
            await connection.confirmTransaction(
              {
          ...
          if (value.err) {
            throw new Error(
              `Transaction ${finalizeSignature} failed (${JSON.stringify(
                value
              )})`
            );
          }
    ...
    var fastStableStringify = getDefaultExportFromCjs(
    ...
    var CommonClient = class extends EventEmitter {
      ...
      constructor(
        ...
        address = 'ws://localhost:8080',
        {
          ...
          reconnect_interval: reconnect_interval = 1e3,
      ...
      notify(method, params) {
        return new Promise((resolve, reject) => {
          if (!this.ready) return reject(new Error('socket not ready'));
          const message = { jsonrpc: '2.0', method: method, params: params };
    ...
    class AddressLookupTableAccount {
      ...
      static deserialize(accountData) {
        ...
        const { addresses: addresses } = LayoutExports.struct([
          LayoutExports.seq(publicKey(), numSerializedAddresses, 'addresses'),
    ...
    const LookupTableMetaLayout = {
      ...
      layout: LayoutExports.struct([
        ...
        LayoutExports.seq(
          publicKey(),
          LayoutExports.offset(LayoutExports.u8(), -1),
          'authority'
        ),
      ]),
    };
    ...
    const BufferFromRawAccountData = coerce(
      ...
      (value) => bufferExports.Buffer.from(value[0], 'base64')
    );
    ...
    const ParsedOrRawAccountData = coerce(
      union([instance(bufferExports.Buffer), ParsedAccountDataResult]),
    ...
    const ParsedConfirmedTransactionResult = type({
      ...
      message: type({
        ...
        addressTableLookups: optional(
          nullable(array(AddressTableLookupStruct))
        ),
      }),
    });
    ...
    const GetLatestBlockhashRpcResult = jsonRpcResultAndContext(
      type({ blockhash: string(), lastValidBlockHeight: number() })
    );
    ...
    const GetFeeCalculatorRpcResult = jsonRpcResultAndContext(
      nullable(
        type({ feeCalculator: type({ lamportsPerSignature: number() }) })
      )
    );
    ...
    const COMMON_HTTP_HEADERS = { 'solana-client': `js/${'1.95.8'}` };
    class Connection {
      constructor(endpoint, _commitmentOrConfig) {
        ...
        this.getBlockHeight = (() => {
          ...
          return async (commitmentOrConfig) => {
            const { commitment: commitment, config: config } =
      ...
      async getStakeActivation(publicKey, commitmentOrConfig, epoch) {
        ...
        const args = this._buildArgs(
          ...
          commitment,
          undefined,
          { ...config, epoch: epoch != null ? epoch : config?.epoch }
        );
      ...
      async confirmTransaction(strategy, commitment) {
        ...
        if (typeof strategy === 'string') {
          ...
          return await this.confirmTransactionUsingBlockHeightExceedanceStrategy(
            { commitment: commitment || this.commitment, strategy: strategy }
          );
        } else {
          ...
          try {
            signatureSubscriptionId = this.onSignature(
              ...
              (result, context) => {
                ...
                const response = { context: context, value: result };
                resolve({
            ...
            (async () => {
              ...
              if (value?.err) {
                ...
                resolve({
                  __type: TransactionStatus.PROCESSED,
                  response: { context: context, value: value },
                });
              }
            })();
          } catch (err) {
      ...
      async confirmTransactionUsingDurableNonceStrategy({
        ...
        const expiryPromise = new Promise((resolve) => {
          ...
          const getCurrentNonceValue = async () => {
            try {
              const { context: context, value: nonceAccount } =
      ...
      async getParsedTransactions(signatures, commitmentOrConfig) {
        ...
        const batch = signatures.map((signature) => {
          ...
          return { methodName: 'getTransaction', args: args };
        });
      ...
      async getStakeMinimumDelegation(config) {
        const { commitment: commitment, config: configArg } =
      ...
      async simulateTransaction(
        ...
        if ('message' in transactionOrMessage) {
          ...
          const encodedTransaction =
            bufferExports.Buffer.from(wireTransaction).toString('base64');
      ...
      async sendTransaction(transaction, signersOrOptions, options) {
        ...
        if (
          ...
          !Array.isArray(signersOrOptions)
        ) {
          throw new Error('Invalid arguments');
        }
      ...
      _wsOnClose(code) {
        ...
        Object.entries(this._subscriptionsByHash).forEach(
          ([hash, subscription]) => {
            this._setSubscription(hash, { ...subscription, state: 'pending' });
          }
        );
      }
      ...
      _wsOnAccountNotification(notification) {
        const { result: result, subscription: subscription } = create(
          notification,
      ...
      _wsOnProgramAccountNotification(notification) {
        ...
        this._handleServerNotification(subscription, [
          { accountId: result.value.pubkey, accountInfo: result.value.account },
          result.context,
        ]);
      }
      ...
      onSignatureWithOptions(signature, callback, options) {
        const { commitment: commitment, ...extra } = {
          ...options,
          commitment:
            (options && options.commitment) || this._commitment || 'finalized',
        };
    ...
    class AddressLookupTableInstruction {
      ...
      static decodeCreateLookupTable(instruction) {
        ...
        const { recentSlot: recentSlot } = decodeData$1(
      ...
      static decodeExtendLookupTable(instruction) {
        ...
        const { addresses: addresses } = decodeData$1(
    ...
    class AddressLookupTableProgram {
      ...
      static createLookupTable(params) {
        const [lookupTableAddress, bumpSeed] = PublicKey.findProgramAddressSync(
          [
            ...
            browserExports$1.toBufferLE(BigInt(params.recentSlot), 8),
          ],
          this.programId
        );
      ...
      static freezeLookupTable(params) {
        ...
        const data = encodeData(type);
        const keys = [
          { pubkey: params.lookupTable, isSigner: false, isWritable: true },
          { pubkey: params.authority, isSigner: true, isWritable: false },
        ];
        return new TransactionInstruction({
          programId: this.programId,
    ...
    class ComputeBudgetInstruction {
      ...
      static decodeRequestUnits(instruction) {
        this.checkProgramId(instruction.programId);
        const { units: units, additionalFee: additionalFee } = decodeData$1(
      ...
      static decodeRequestHeapFrame(instruction) {
        this.checkProgramId(instruction.programId);
        const { bytes: bytes } = decodeData$1(
      ...
      static decodeSetComputeUnitLimit(instruction) {
        this.checkProgramId(instruction.programId);
        const { units: units } = decodeData$1(
      ...
      static decodeSetComputeUnitPrice(instruction) {
        this.checkProgramId(instruction.programId);
        const { microLamports: microLamports } = decodeData$1(
    ...
    const ED25519_INSTRUCTION_LAYOUT = LayoutExports.struct([
    ...
    class Ed25519Program {
      ...
      static createInstructionWithPublicKey(params) {
        ...
        const instructionData = bufferExports.Buffer.alloc(
    ...
    class SHA256 extends HashMD$1 {
      ...
      process(view, offset) {
        ...
        for (let i = 0; i < 64; i++) {
          ...
          const T1 =
            (H + sigma1 + Chi$1(E, F, G) + SHA256_K[i] + SHA256_W[i]) | 0;
    ...
    const SECP256K1_INSTRUCTION_LAYOUT = LayoutExports.struct([
      LayoutExports.u8('numSignatures'),
      LayoutExports.u16('signatureOffset'),
    ...
    class Secp256k1Program {
      ...
      static createInstructionWithPrivateKey(params) {
        ...
        try {
          ...
          const messageHash = bufferExports.Buffer.from(
            keccak_256(toBuffer(message))
          );
    ...
    class StakeInstruction {
      ...
      static decodeInitialize(instruction) {
        this.checkProgramId(instruction.programId);
        this.checkKeyLength(instruction.keys, 2);
        const { authorized: authorized, lockup: lockup } = decodeData$1(
    ...
    class VoteInstruction {
      ...
      static decodeInitializeAccount(instruction) {
        ...
        const { voteInit: voteInit } = decodeData$1(
      ...
      static fromConfigData(buffer) {
        ...
        if (configKeys[0].publicKey.equals(VALIDATOR_INFO_KEY)) {
          if (configKeys[1].isSigner) {
            const rawInfo = rustString().decode(
              bufferExports.Buffer.from(byteArray)
            );
    ...
    const VoteAccountLayout = LayoutExports.struct([
      ...
      LayoutExports.struct(
        [LayoutExports.nu64('slot'), LayoutExports.nu64('timestamp')],
        'lastTimestamp'
      ),
    ]);
    class VoteAccount {
    ...
    function parseAuthorizedVoter({
      ...
      return { epoch: epoch, authorizedVoter: new PublicKey(authorizedVoter) };
    }
    ...
    function getPriorVoters({ buf: buf, idx: idx, isEmpty: isEmpty }) {
      if (isEmpty) {
        return [];
      }
      return [
