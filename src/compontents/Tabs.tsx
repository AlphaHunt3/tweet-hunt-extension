          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`grow-0 shrink-0 px-4 py-2.5 text-sm font-medium transition-colors relative whitespace-nowrap text-center group ${
                activeTab === tab.id
                  ? 'text-xhunt-accent tab-button-active'
                  : tab.disabled
                    ? 'theme-text-secondary opacity-40 cursor-not-allowed'
            ...
            >
              ...
              {activeTab === tab.id && (
                <span className='absolute bottom-0 left-0 right-0 h-0.5 bg-xhunt-accent tab-indicator' />
              )}
              ...
              {Boolean(tab.tooltip) && (
                <div
                  ...
                  style={
                    tooltipMaxWidth ? { maxWidth: tooltipMaxWidth } : undefined
                  }
                >
