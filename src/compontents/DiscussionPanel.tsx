      ...
      <div className='flex items-center justify-between mb-2'>
        <div className='flex items-center gap-2'>
          ...
          <span className='text-xs theme-text-secondary'>
            {Number(discussionData.positivePercentage).toFixed(2)}%{' '}
            {t('positive')}
          </span>
        </div>
        <div className='flex items-center gap-2'>
          ...
          <span className='text-xs theme-text-secondary'>
            {Number(discussionData.negativePercentage).toFixed(2)}%{' '}
            {t('negative')}
          </span>
        </div>
      </div>
        ...
        <div className='space-y-2'>
          ...
          <ul className='space-y-1'>
            {discussionData.positiveBulletPoints.map((point, index) => (
              <li
                key={index}
                className='text-xs theme-text-primary leading-relaxed pl-4 relative'
              >
