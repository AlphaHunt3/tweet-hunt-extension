...
function IndexPopup() {
  ...
  const [showTokenAnalysis, setShowTokenAnalysis] = useLocalStorage(
    '@settings/showTokenAnalysis',
    true
  );
  const [showSearchPanel, setShowSearchPanel] = useLocalStorage(
    '@settings/showSearchPanel',
    true
  );
  const [showHotTrending, setShowHotTrending] = useLocalStorage(
  ...
  return (
    <div
      data-theme={theme}
      className='theme-bg-secondary backdrop-blur-sm px-4 py-2 theme-text-primary w-[280px] shadow-lg'
    >
