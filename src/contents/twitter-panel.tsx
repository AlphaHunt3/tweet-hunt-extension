...
export const getInlineAnchor = () =>
  document.querySelector('div[data-testid="UserName"]')

export const getShadowHostId = () => `twitter-panel`
...
function TwitterPanel() {
  ...
  return <div
    className={`w-full bg-[#000000] text-white overflow-hidden opacity-100 border-b border-t  border-[#2F3336] mb-4`}
  >
    {loading && (
      <div className="absolute inset-0 bg-[#000000]/70 backdrop-blur-[3px] z-10 flex flex-col items-center justify-center pointer-events-auto">
