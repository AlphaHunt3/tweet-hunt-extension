...
import { Users, TrendingUp, Trash2, ChevronDown, ChevronUp, Eye, MessageCircle, Heart, Repeat } from 'lucide-react';
...
function App() {
    ...
    // Simulating multiple deleted tweets for demonstration
    ...
    return (
        <div className="min-h-screen bg-black">
            ...
            <div
                className={`fixed right-4 top-4 w-80 bg-[#15202b] rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.15)] text-white transition-all duration-200 ${
